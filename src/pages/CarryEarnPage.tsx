    ...
    <section className="mx-auto max-w-3xl px-4 py-4 sm:px-6 sm:py-6">
      ...
      <form onSubmit={handleSubmit} className="grid gap-3 rounded-[24px] border border-white/10 bg-[#1f2232]/90 p-3.5 shadow-xl sm:p-4">
        ...
        <Notice title={t("Prohibited and restricted items", "禁运与限制物品")} tone="warning">
          {t("Illegal, dangerous, prohibited, undeclared high-value, or customs/transportation risk items are not allowed. Users are responsible for ensuring compliance with local regulations and transportation requirements.", "禁止发布或运输违法、危险、违禁、高价值未申报或可能引发海关及运输风险的物品。用户需自行确认物品符合出发地及目的地相关规定。")}
        </Notice>
